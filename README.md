...
The data has manually been collected from [Brycchan Carey's website](https://brycchancarey.com/slavery/poetry.htm), who provides a preselection of antislavery poems in digital format.

## Preproccesing
Since the text was already converted to a digital format by Bracchan Carey, no data cleaning measures have been taking. The tokenization and lemmatization was performed using the spaCy library for python, and the code can be reviewed in the Jupyter Notebook in this repo.
